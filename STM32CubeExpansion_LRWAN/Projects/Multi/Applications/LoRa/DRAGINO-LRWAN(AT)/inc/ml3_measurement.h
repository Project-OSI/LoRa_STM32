...
typedef enum {
  ...
  ML3_MEASUREMENT_FAULT_ADC_INIT = 1U << 0,
  ML3_MEASUREMENT_FAULT_ADC_CAL = 1U << 1,
  ML3_MEASUREMENT_FAULT_ADC_TIMEOUT = 1U << 2,
  ML3_MEASUREMENT_FAULT_ADC_OVERRUN = 1U << 3,
  ML3_MEASUREMENT_FAULT_THERM_FAULT = 1U << 15
